...
% channels to run test on. These values apply to 64 chan biosemi
% recorded as a BDF. (other recordings will vary).
FCz = 47;
Cz = 48;
Erg1 = 72;
Erg2 = 73;
